...
void _checkLoadingState() {
  ...
  if (loadingProvider.isScreenChange) {
    ...
    busProvider.resetPosition();  // Asegúrate de reiniciar la posición del bus
    busProvider.startAnimation(this); // Iniciar la animación del bus
            ...
            children: [
              ...
              Consumer<BusProvider>(
                builder: (context, busProvider, child) {
                  ...
                  debugPrint("Bus progress: ${busProvider.busProgress}");
